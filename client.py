...
def display_letters(x, y, w):
    letters = heading.render("Your letters : " + str(w), True, (0, 0, 0))
    screen.blit(letters, (x, y))
...
def display_word(x, y, w):
    word = subheading.render("Your word : " + str(w), True, (0, 0, 0))
    screen.blit(word, (x, y))


def display_score():
    score = subheading.render("SCORE : " + str(my_score) + " / " + str(total_score), True, (0, 0, 0))
